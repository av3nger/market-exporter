...
(0, _jquery.default)(function () {
  ...
  (0, _jquery.default)(document).ready(function () {
    ...
    (0, _jquery.default)('select').select2({
      minimumResultsForSearch: Infinity
    });
    (0, _jquery.default)('#rate-notice').on('click', function () {
      _jquery.default.post(ajax_strings.ajax_url, {
        _ajax_nonce: ajax_strings.nonce,
        action: 'dismiss_rate_notice'
      });
    }); // Disable multiselect if user wants to export all params.

    (0, _jquery.default)('input#params_all').on('click', function () {
      var paramSelect = (0, _jquery.default)('select#params');
      var paramCheckbox = (0, _jquery.default)(this).prop('checked');
